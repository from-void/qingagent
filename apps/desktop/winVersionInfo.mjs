...
export async function stampWinVersionInfo(executablePath, options = {}) {
  ...
  return verifyWinVersionInfo(executablePath, { version, expectedStrings: versionStrings });
}

function printVerified(executablePath, entries) {
...
async function main() {
  ...
  printVerified(executablePath, entries);
}
