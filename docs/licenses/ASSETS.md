...
| 资产 | 位置 | 来源与许可 | 说明 |
|---|---|---|---|
| 精选背景图(70 文件,6 png + 64 jpg) | `apps/web/public/curated-backgrounds/` | 作者使用 AI 生成,无第三方版权主张 | 随仓库以 MIT 分发 |
...
| 瀑布流组件 | `packages/chinese-masonry/` | vendored,上游许可与差异记录见包内 `VENDORING.md` | 包本身 MIT |
