...
describe("run_python capability tool", () => {
  ...
  it("审查母技能声明两种代码执行工具，一致性 reference 强制真实验算", async () => {
    const skillPath = fileURLToPath(new URL("../../skills/capability/review/SKILL.md", import.meta.url));
    const referencePath = fileURLToPath(new URL("../../skills/capability/review/references/consistency.md", import.meta.url));
