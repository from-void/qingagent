...
import { migration0037ReviewSupplementTemplateScope } from "../migrations/0037_review_supplement_template_scope.js";
...
describe("0037 review supplement template scope", () => {
  it("把旧 (doc_id,type) 记录原样迁到空模板作用域", async () => {
    ...
    await migration0037ReviewSupplementTemplateScope.up(client);
